...
# ruby build_component type:organism name:ProductDetails
#
...
File.open(component_path, "w") do |f|
  ...
  f.write("\n")
  f.write("const Container = styled.div``;\n")
  f.write("\n")
  f.write("const #{component_name} = (props) => {\n")
  f.write("  const { placeholder } = props;\n")
  f.write("\n")
  f.write("  return (\n")
  f.write("    <Container>\n")
  f.write("      {placeholder}\n")
  ...
  f.write("  */\n")
  f.write("  placeholder: PropTypes.string,\n")
  f.write("};\n")
  f.write("\n")
